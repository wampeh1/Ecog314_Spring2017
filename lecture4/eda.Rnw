...
\item heavy cars (above averge weight)
...
Use the \R{[i, j]} format to subset rows. Only the observations specified by the \R{i} expression are affected. Repeat as neccessary
\pause
<< >>=
